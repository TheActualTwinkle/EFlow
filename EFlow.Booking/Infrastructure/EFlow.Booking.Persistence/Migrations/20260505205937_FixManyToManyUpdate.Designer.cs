...
namespace EFlow.Booking.Persistence.Migrations
{
    ...
    [Migration("20260505205937_FixManyToManyUpdate")]
    partial class FixManyToManyUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFlow.Booking.Domain.Students.Student", b =>
                {
                    b.HasOne("EFlow.Booking.Domain.Groups.Group", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EFlow.Booking.Domain.Subjects.Subject", b =>
                {
                    b.HasOne("EFlow.Booking.Domain.Teachers.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EFlow.Booking.Domain.SubmissionSlots.SubmissionSlot", b =>
                {
                    b.HasOne("EFlow.Booking.Domain.Subjects.Subject", null)
                        .WithMany()
